...
class StaffListResponseModel {
  ...
  StaffListResponseModel(
      {this.status, this.message, this.staffListResponseModelData});
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        staffListResponseModelData!
            .add(new StaffListResponseModelData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.staffListResponseModelData != null) {
      data['data'] =
          this.staffListResponseModelData!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class StaffListResponseModelData {
  ...
  StaffListResponseModelData.fromJson(Map<String, dynamic> json) {
    ...
    staff = json['user'] != null ? new Staff.fromJson(json['user']) : null;
