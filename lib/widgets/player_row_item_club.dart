...
class PlayerRowItemClub extends StatefulWidget {
  PlayerListResponseModelData? player;
  Function? onSelect;

  PlayerRowItemClub({Key? key, this.player, this.onSelect}) : super(key: key);

  @override
  _PlayerRowItemClubState createState() => _PlayerRowItemClubState();
}

class _PlayerRowItemClubState extends State<PlayerRowItemClub> {
  PlayerListResponseModelData? player;
  ...
  String gersi() {
    ...
    if (player!.jerseyNumber == null) {
      ...
      ff = ff + player!.jerseyNumber!.substring(1);
    }
        ...
        child: InkWell(
          ...
          child: GestureDetector(
              onTap: () {
                ...
                PlayerListResponseModelData p = player!;
