...
class MyCustomTextField extends StatefulWidget{
  ...
  const MyCustomTextField({Key? key, this.onChange, required this.labelText, this.hintText, this.obscureText = false, this.textInputType=TextInputType.text, this.controller, this.showCountryCode=false, this.countryCodeController, this.subtitleText, required this.fieldType, this.lines=1, this.locked=false, this.useIcon=false, this.subtitlePosition=SubtitlePosition.BOTTOM, this.isDarkModeEnabled, this.inputFormatters,this.autoFocus = false, this.focusNode, this.confirmationController, this.maxLength, this.expected, this.lockPosition=LockPosition.TOP, this.showSubtitle=true}) : super(key: key);
...
class _MyCustomTextFieldState extends State<MyCustomTextField> {
  ...
  fieldOnchangeMap[FieldType.PENSION_USERNAME_FIELD]=pensionUsernameOnchange;
  fieldOnchangeMap[FieldType.RSA_FIELD]=rsaOnchange;
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                      borderSide: BorderSide(color: widget.showCountryCode ? sonaBlack : getColorHexFromStr("5E5E5E"), width: 0.0),
                    ),
...
enum FieldType {
  PENSION_USERNAME_FIELD, RSA_FIELD, EMAIL_FIELD, USERNAME_FIELD, FIRST_NAME_FIELD, LAST_NAME_FIELD, MIDDLE_NAME_FIELD, PHONE_NUMBER_FIELD, PASSWORD_FIELD, ADDRESS_FIELD, REQUIRED_FIELD, NOT_REQUIRED_FIELD, PHONE_NUMBER_EMAIL_FIELD, PASSWORD, PASSWORD_CONFIRMATION, BVN, ACCOUNT_NUMBER, RESET_TOKEN
}
