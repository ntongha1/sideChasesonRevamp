class VideoComparisonResponseModel {
  String? status;
  String? message;
  List<Data>? data;

  VideoComparisonResponseModel({this.status, this.message, this.data});

  VideoComparisonResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data({this.uploadId, this.player, this.playerStats});
...
class PlayerStats {
  ...
  Speed? speed;
  Speed? distance;
  Cornerkick? cornerkick, longShot, yellowCard, shot, dribble, redCard, tackle, goal;
  BallSaved? ballSaved;
