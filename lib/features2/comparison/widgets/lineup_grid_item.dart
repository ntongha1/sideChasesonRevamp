        ...
        onTap: () {
          //if (widget.lineupData!.players!.profileUpdated == 0) {
            showDialog(
                ...
                builder: (BuildContext context) => VerifyPlayerPopUpScreen(playerID: widget.lineupData!.playerId!)).then((value) {
                  if (value) {
            pushNewScreen(
               context,
                 screen: PlayerLineUpSingletonScreen(playerID: widget.lineupData!.playerId!),
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
                width: 150.0,
                child: Text(
                  widget.lineupData!.players![0].firstName!.substring(0, 1).toUpperCase() + widget.lineupData!.players![0].lastName!.substring(1),
