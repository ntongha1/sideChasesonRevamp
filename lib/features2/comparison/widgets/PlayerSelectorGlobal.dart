...
class PlayerSelectorGlobalScreen extends StatefulWidget {
  var match;
  ...
  @override
  _PlayerSelectorGlobalScreenState createState() =>
      _PlayerSelectorGlobalScreenState();
}

class _PlayerSelectorGlobalScreenState extends State<PlayerSelectorGlobalScreen>
  ...
  getPlayers() async {
    print("match::::" + widget.match["fixture"]["id"].toString());
    setState(() {
      loadingMatches = true;
    });
    String url = ApiConstants.getFixtureByIDSonaBackend +
        widget.match["fixture"]["id"].toString();
    print(url);
    ...
    if (res.statusCode == 200) {
      ...
      print('players:' + data['data']['response'].toString());
      print("lennn: ");
      print("lennn: " + data['data']['response'].length.toString());
      if (data['data']['response'] == "[]" ||
          data['data']['response'].length.toString() == 0 ||
          data['data']['response'].length.toString() == "0" ||
          data['data']['response'] == null ||
          data['data']['response'] == []) {
        print("data is empty lennn");
        setState(() {
      ...
      setState(() {
        aplayers = data['data']['response'][0]['players'];
        asplayers = data['data']['response'][0]['players'];
        bplayers = data['data']['response'][1]['players'];
        bsplayers = data['data']['response'][1]['players'];
