...
class _TvtState extends State<Tvt> {
  ...
  Widget build(BuildContext context) {
    ...
    child: BlocListener(
        ...
        listener: (_, state) {
          if (state is AnalysedVideosLoading || state is AnalysedVideosSingletonLoading) {
            isLoading = true;
            context.loaderOverlay.show();
          }

          if (state is AnalysedVideosError || state is AnalysedVideosSingletonLoading) {
            isLoading = false;
                ...
                children: [
                  ...
                  videoListResponseModel!.videoListResponseModelData!.length > 0
                      ...
                      onChanged: (val) async {
                        ...
                        //load all analysed videos
                        await serviceLocator<CommonCubit>().getAnalysedVideosSingleton(_selectedVideo!.id!);
                        setState(() {});
                      },
                  ...
                  if (videoListResponseModel!.videoListResponseModelData!.isNotEmpty && !submited)
                    Container(
