...
class PVPTableWidget extends StatefulWidget {
  pvp.ComparePVPModel stats;
  pvp.PillModel currentPill;

  PVPTableWidget({Key? key, required this.stats, required this.currentPill})
      : super(key: key);

  @override
  _PVPTableWidgetState createState() => _PVPTableWidgetState();
}

class _PVPTableWidgetState extends State<PVPTableWidget> {
  int activeIndex = 0;
  pvp.ComparePVPModel? stats;
