...
class TVTTableWidget extends StatefulWidget {
  tvt.CompareTVTModel stats;
  pvp.PillModel currentPill;

  TVTTableWidget({Key? key, required this.stats, required this.currentPill})
      : super(key: key);

  @override
  _TVTTableWidgetState createState() => _TVTTableWidgetState();
}

class _TVTTableWidgetState extends State<TVTTableWidget> {
  int activeIndex = 0;
  tvt.CompareTVTModel? stats;
