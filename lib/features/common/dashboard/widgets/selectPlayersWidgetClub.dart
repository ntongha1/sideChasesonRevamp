...
import 'package:sonalysis/widgets/player_row_item_club.dart';
import '../../../../../../core/datasource/local_storage.dart';
import '../../../../../core/enums/user_type.dart';
import '../../../../../core/utils/styles.dart';

class SelectPlayersWidgetClub extends StatefulWidget {
  bool single = false;
  String? clubId;
  ...
  @override
  _SelectPlayersWidgetClubState createState() =>
      _SelectPlayersWidgetClubState();
}

class _SelectPlayersWidgetClubState extends State<SelectPlayersWidgetClub> {
  ...
  bool isLoading = true;
  PlayerListResponseModel? playersInATeamModel;
  PlayerListResponseModel? playersInATeamModelAll;
  List<PlayerListResponseModelData> playersSelected = [];
  List<PlayerListResponseModelData> playersAll = [];
  List<PlayerListResponseModelData> playersFiltered = [];
  int len = 0;
  ...
  Future<void> _getData() async {
    ...
    await serviceLocator<CommonCubit>().getPlayerList(widget.clubId!);
  ...
  void searchNow(String? v) {
    ...
    List<PlayerListResponseModelData> temp = playersAll.where((element) {
      String fname =
      ...
      child: BlocListener(
        ...
        listener: (_, state) {
          ...
          if (state is PlayerListSuccess) {
            context.loaderOverlay.hide();
            PlayerListResponseModel p =
                serviceLocator.get<PlayerListResponseModel>();
            setState(() {
              isLoading = false;
              playersInATeamModelAll = p;
              playersInATeamModel = p;
              playersAll = p.playerListResponseModelData!;
              playersFiltered = p.playerListResponseModelData!;
            });
          }
        },
        child: Container(
