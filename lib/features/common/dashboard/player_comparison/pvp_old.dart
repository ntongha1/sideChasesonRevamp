        ...
        child: BlocListener(
            ...
            listener: (_, state) {
              if (state is AnalysedVideosLoading ||
                  state is AllPlayerInUploadedVideoLoading ||
                  state is ComparePlayersLoading) {
                isLoading = true;
                context.loaderOverlay.show();
              }

              if (state is AnalysedVideosError ||
                  state is AllPlayerInUploadedVideoError ||
                  state is ComparePlayersError) {
                isLoading = false;
              ...
              if (state is AllPlayerInUploadedVideoSuccess) {
                ...
                allPlayerInUploadedVideoModel =
                    state.allPlayerInUploadedVideoModel;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        showPlayerSelection //video selected
                            ? allPlayerInUploadedVideoModel!.data!.teamA ==
                                        null ||
                                    allPlayerInUploadedVideoModel!
                                            .data!.teamB ==
                                        null //no players
                                ? Text(
                                    "No Player in the selected video"
                                        .tr()
                                        .toUpperCase(),
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
