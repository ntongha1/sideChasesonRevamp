...
class _VvvState extends State<Vvv> {
  ...
  bool isLoading = true,
      videoASelected = false,
      videoBSelected = false,
      submited = false;
                                    ...
                                    Container(
                                      ...
                                      child: AppButton(
                                          ...
                                          onPressed: () async {
                                            await serviceLocator<CommonCubit>()
                                                .compareVideos(
                                                    videoASelectedDetails!.id!,
                                                    videoBSelectedDetails!.id!);
                                          }),
                                    ),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          playerFeatures(
                                              compareVideosModel!
                                                  .compareVideosModelData![0]
                                                  .ballPossession!
                                                  .toString(),
                                              compareVideosModel!
                                                  .compareVideosModelData![1]
                                                  .ballPossession!
                                                  .toString(),
                                              "Ball Possession".tr()),
                                          const SizedBox(height: 30),
