class PillModel {
  ...
  PillModel({required this.title, required this.key, required this.value});

  Map<String, dynamic> toMap() {
    return {'title': title, 'key': key, 'value': value};
  }
}

class ComparePVPModel {
  String? status;
  String? message;
  List<Data>? data;

  ComparePVPModel({this.status, this.message, this.data});

  ComparePVPModel.fromJson(Map<dynamic, dynamic> json) {
    status = json['status'];
