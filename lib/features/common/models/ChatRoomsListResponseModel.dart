class ChatRoomsListResponseModel {
  String? status;
  String? message;
  List<Data>? data;

  ChatRoomsListResponseModel({this.status, this.message, this.data});

  ChatRoomsListResponseModel.fromJson(Map<dynamic, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['livekit_token'] = this.livekitToken;
