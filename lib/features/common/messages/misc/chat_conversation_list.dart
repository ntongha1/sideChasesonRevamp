...
import '../singleton/ChatScreenSingleton.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        pushNewScreen(
          context,
          screen: ChatScreenSingleton(name: widget.name, userID: widget.userID, livekitToken: widget.livekitToken, imageUrl: widget.imageUrl, isOnline: widget.isOnline),
